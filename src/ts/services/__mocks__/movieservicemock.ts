...
export let mockListOfMovies: IMovie[] = [
    {
        ...
        Type: 'movie',
        Poster:
            'https://m.media-amazon.com/images/M/MV5BOTA4MTg1ODkwNF5BMl5BanBnXkFtZTcwMzE5ODAxMw@@._V1_SX300.jpg',
    },
    {
    ...
    },
    {
        ...
        Type: 'movie',
        Poster:
            'https://m.media-amazon.com/images/M/MV5BZDc4ODcyNWMtMzI2Zi00YzcwLWE4ZTUtYWM3OWI1MTgwYTc1XkEyXkFqcGdeQXVyNzc5MjA3OA@@._V1_SX300.jpg',
    },
    {
        Title: 'Remember Me',
        Year: '2010',
